...
export default async function AccommodationDetailPage({
    ...
    return (
        <main className="bg-[#FFFEF8] min-h-screen">
            ...
            <section className="px-4 mt-4 relative">
                <div className="relative h-[420px] md:h-[520px] overflow-hidden rounded-[24px]">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <h1 className="text-white font-ogg-regular text-5xl md:text-7xl text-center">
                            Book Your Stay
                        </h1>
                    </div>
                </div>
            ...
            <section className="max-w-[1140px] mx-auto relative z-30 px-6 mt-6 sm:-mt-[70px] md:-mt-[85px] mb-4 sm:mb-0">
                
                <div className="grid grid-cols-2 gap-2.5 sm:flex sm:items-end sm:gap-2.5">
                    <button className="bg-[#C22D28] text-white px-3 sm:px-7 py-4 sm:pt-5 sm:pb-4 text-[11px] sm:text-[12px] tracking-wider uppercase font-bold rounded-xl sm:rounded-b-none sm:rounded-t-xl shrink-0 h-[54px] sm:h-[58px] transition-all duration-150 font-jeko-black w-full sm:w-auto">
                        5-Bedroom Beach House
                    </button>
                    <button className="bg-[#E5D7D7] hover:bg-[#dbd2c8] text-[#8A7E74] px-3 sm:px-6 py-4 sm:py-3.5 text-[11px] tracking-wider uppercase font-bold rounded-xl sm:rounded-b-none sm:rounded-t-xl shrink-0 font-jeko-black h-[54px] sm:h-[48px] transition-all duration-150 w-full sm:w-auto">
                        Deluxe Room
                    </button>
                    <button className="bg-[#E5D7D7] hover:bg-[#dbd2c8] text-[#8A7E74] px-3 sm:px-6 py-4 sm:py-3.5 text-[11px] tracking-wider uppercase font-bold rounded-xl sm:rounded-b-none sm:rounded-t-xl shrink-0 font-jeko-black h-[54px] sm:h-[48px] transition-all duration-150 w-full sm:w-auto">
                        Standard Room
            ...
            <section className="max-w-[1140px] mx-auto relative z-20 px-6 pb-20">
                    ...
                    <div className="grid lg:grid-cols-12 gap-10 items-start">
                        ...
                        <div className="w-full lg:col-span-5 shrink-0">
                            ...
                            {/* <div className="grid grid-cols-3 gap-3 mt-4">
                                ...
                                <div className="h-[65px] bg-[#1a1a1a]/90 hover:bg-black rounded-xl flex items-center justify-center text-white text-[11px] tracking-widest uppercase font-medium cursor-pointer transition">
                                    Gallery
                                </div>
                            </div> */}
                            <div className="grid grid-cols-3 gap-3 mt-4">
                        ...
                        <div className="w-full lg:col-span-7 flex flex-col justify-between min-h-[440px] pt-2">
                            <div>
                                <h2 className="font-ogg-regular text-[#7CA5C8] text-[44px] leading-tight font-light">
                                    {room.title || "The Villa"}
                                </h2>

                                <p className="mt-4 text-[#555555] text-[14px] leading-relaxed max-w-[540px] font-jako-regular">
                                ...
                                <div className="grid grid-cols-2 gap-y-5 gap-x-8 mt-10 text-[13px] text-[#444]">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="font-jeko-bold">Hot & Cold Shower</span>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="font-jeko-bold">Air Conditioning</span>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="font-jeko-bold">High-Speed WiFi</span>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="font-jeko-bold">Equipped Kitchenette</span>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="font-jeko-bold">Mini Fridge</span>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="font-jeko-bold">Flat Screen TV</span>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="font-jeko-bold">On-Request Laundry</span>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="font-jeko-bold">Butler Service</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="w-full max-w-[513px] min-h-[188px] bg-[#FFFEF8] border border-[#E7DDD4] rounded-[12px] p-[24px] mt-10">
                                <div className="grid grid-cols-3">
                                    ...
                                    <div className="pr-2 sm:pr-6 border-r border-[#D8D0C8]">
                                        <p className="text-[10px] sm:text-[11px] uppercase tracking-[1px] sm:tracking-[2px] text-[#A69C94] mb-2">
                                            Check In
                                        </p>
                                        <div className="flex items-center justify-between gap-1">
                                            <span className="text-[#BC2623] text-[13px] sm:text-[15px] font-medium tracking-[0.5px] sm:tracking-[1px]">
                                                2026-05-28
                                            </span>
                                    ...
                                    <div className="pl-2 sm:pl-6">
                                        ...
                                        <div className="flex items-center justify-between gap-1">
                                            <span className="text-[#BC2623] text-[13px] sm:text-[15px] font-medium tracking-[0.5px] sm:tracking-[1px] uppercase">
                                                2 Adults
                                            </span>
                                            <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="m6 9 6 6 6-6" />
                                ...
                                <div className="mt-9 flex justify-center sm:block">
                                    <button className="w-full max-w-[304px] h-[62px] rounded-full border border-[#BC2623] bg-[#BC2623] text-white uppercase text-[14px] font-semibold tracking-[1.5px] shadow-[0_10px_25px_rgba(0,0,0,0.18)] transition-all duration-300 hover:bg-[#A92320]">
