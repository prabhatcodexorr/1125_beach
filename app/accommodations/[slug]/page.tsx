                        ...
                        return (
                            <Link
                                ...
                                className={`
                                    ...
                                    ${isActive
                                        ? "bg-[#AF2F2C] text-[#FAF0E2] h-[54px] sm:h-[58px] sm:pt-5 sm:pb-4 pointer-events-none"
                    ...
                    <div className="grid lg:grid-cols-12 gap-10 items-start">
                        ...
                        <div className="w-full lg:col-span-7 flex flex-col justify-between min-h-[440px] pt-2">
                            <div>
                                ...
                                {/* Features Grid (Aapka original features wala section yahan rahega) */}
                            ...
                            {/* BOOKING SECTION - Yahan changes kiye hain */}
                            <div className="w-full max-w-[600px] bg-[#FFFEF8] border border-[#E7DDD4] rounded-[12px] p-[24px] mt-10">

                                {/* Is div ko grid mein convert kiya hai taaki Quantity side mein aa sake */}
                                <div className={`grid grid-cols-1 gap-4 items-end ${slug === "chalets" ? "md:grid-cols-4" : "md:grid-cols-1"}`}>

                                    {/* Booking Box (Dates aur Guests) */}
                                    <div className={slug === "chalets" ? "md:col-span-4" : "w-full"}>
                                        {/* <BookingBox /> */}
                                        {slug === "chalets" && (
