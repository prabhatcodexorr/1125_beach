...
export default function BookingBox() {
    ...
    return (
        <div
            ref={dropdownRef}
            // Dynamic Grid: Agar children > 0 hain to 4 column, warna 3 column
            className={`grid grid-cols-1 ${children > 0 ? "md:grid-cols-4" : "md:grid-cols-3"} relative gap-4 md:gap-0 w-full transition-all duration-300`}
        >
            {/* 1. Check In */}
            ...
            {/* 3. Adults Column */}
            <div className={`py-4 md:py-0 md:px-[28px] relative w-full flex flex-col justify-between border-b md:border-b-0 ${children > 0 ? "md:border-r border-[#D8D0C8]" : ""}`}>
                <p className="text-[10px] sm:text-[11px] lg:text-[12px] uppercase tracking-[2px] text-[#A69C94] mb-2 font-jako-regular">
                    Adults
                </p>
                <button
                ...
                >
                    ...
                    {/* Arrow sirf tab dikhao jab children 0 ho, warna children wale column me dikhega */}
                    {children === 0 && (
            ...
            {/* 4. Children Column (Conditional) */}
            {children > 0 && (
                <div className="py-4 md:py-0 md:px-[28px] relative w-full flex flex-col justify-between border-b md:border-b-0">
                    <p className="text-[10px] sm:text-[11px] lg:text-[12px] uppercase tracking-[2px] text-[#A69C94] mb-2 font-jako-regular">
                        Children
                    </p>
                    <button
            ...
            {activeDropdown === "guests" && (
                <div className="absolute top-full right-0 mt-2 w-[280px] bg-white rounded-xl shadow-2xl border border-[#D8D0C8] p-5 z-[99999] flex flex-col gap-4">
                    ...
                    <button
                        ...
                        className="w-full mt-2 py-3 bg-[#BC2623] text-white text-[12px] font-jako-bold uppercase tracking-[1px] rounded-lg hover:bg-[#a1201e] transition-colors"
                    >
                        Done
                    </button>
                </div>
