   ...
   <div className="block md:hidden">
      <div className="relative h-[520px] rounded-[40px] overflow-hidden">
         ...
         <div className="absolute inset-0 bg-black/20" />
            <div className="absolute inset-0 flex flex-col items-center justify-end text-center px-5 pb-8">
               {/* Logo */}
               <div className="mb-8">
                  <svg
                     width="58"
               ...
               <h1 className="font-ogg-trial text-white text-[38px] leading-[42px] drop-shadow-lg">
                  Lose Your Shoes.
                  <br />
                  Find Your Soul.
               </h1>
               <p className="mt-4 max-w-[320px] text-white/95 text-sm leading-relaxed font-manrope-regular">
                  Experience a sanctuary where the only schedule is the tide and
                  the only dress code is the sand.
               </p>
               <form className="mt-6 w-full max-w-[360px] bg-white rounded-[28px] p-2 shadow-2xl">
                  <div className="flex flex-col gap-2">
                     <input
                        type="text"
                        placeholder="2026-05-03"
                        className="w-full px-5 py-4 text-center text-base font-semibold text-[#7f92aa] bg-transparent outline-none"
                        />
                     <button
                        type="submit"
                        className="w-full rounded-full bg-[#BC2623] hover:bg-[#a71f1d] py-4 text-sm font-bold uppercase tracking-[1.5px] text-white transition-all duration-300"
                        >
                     Book A Chalet
                     </button>
                  </div>
