...
<section className="relative">
   ...
   style={{
  backgroundImage: "url('/images/newsletter-bg1.jpg')",
         ...
         <div className="text-center w-full max-w-[640px]">
            ...
            <form
               ...
               <div
                  ...
                  <button
                     type="submit"
                     className="w-[48px] h-[48px] md:w-[54px] md:h-[54px] lg:w-[61px] lg:h-[61px] flex items-center justify-center transition-all duration-300 hover:scale-105 shrink-0 opacity-100"
                     >
                     <svg
                        viewBox="0 0 57 57"
