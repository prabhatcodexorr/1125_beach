    ...
    <section className="relative overflow-hidden bg-[#7CA5C8] py-[80px] lg:py-[100px] w-full select-none">
      ...
      <div className="w-full relative z-10">
        ...
        <div className="w-full relative overflow-visible">
          <div
            ...
            className={`flex gap-[42px] overflow-x-auto pb-6 w-full scroll-smooth snap-x snap-mandatory style-scroll-container 
              px-6 md:px-12 lg:px-[77px] scroll-pl-6 md:scroll-pl-12 lg:scroll-pl-[77px] ${
                ...
                <div className="border border-white rounded-[18px] p-[14px] bg-white/[0.06] backdrop-blur-[8px] flex flex-col h-[450px] lg:h-[500px] w-full shadow-sm">
                  <div>
                    ...
                    <div className="flex justify-between items-start gap-3 pt-5 px-1">
                      <h3 className="font-ogg-regular text-white text-[22px] lg:text-[24px] leading-[1.15] font-normal tracking-wide capitalize">{tour.title}</h3>
                      <button className="w-[38px] h-[38px] rounded-full bg-[#C42924] hover:bg-[#A3201C] flex items-center justify-center shrink-0 transition-colors mt-0.5 shadow-sm cursor-pointer">
        ...
        <div className="text-center mt-12 md:mt-16">
          <button className="w-[218px] h-[52px] rounded-[50px] bg-[#C42924] hover:bg-[#A3201C] text-white text-[14px] font-[700] tracking-[1.2px] uppercase transition-all font-manrope-regular">
            Make A Reservation
          </button>
        </div>
      </div>
